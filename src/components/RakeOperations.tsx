...
const RakeOperations: React.FC = () => {
  ...
  const getRakeFields = () => {
    const commonFields = [
      ...
      { key: 'timeIn', label: 'Port Entry Time', type: 'datetime-local' as const, required: true, placeholder: 'Select port entry time' },
      { key: 'timeOut', label: 'Port Exit Time', type: 'datetime-local' as const, required: false, placeholder: 'Select port exit time (optional)' },
