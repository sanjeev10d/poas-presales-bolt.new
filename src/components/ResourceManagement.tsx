...
const ResourceManagement: React.FC = () => {
  ...
  const equipmentFields = [
    ...
    { key: 'lastUsed', label: 'Last Used Time', type: 'datetime-local' as const, required: true, placeholder: 'Select last used time' },
    ...
    { key: 'lastMaintenance', label: 'Last Maintenance Date', type: 'datetime-local' as const, required: true, placeholder: 'Select last maintenance date' },
