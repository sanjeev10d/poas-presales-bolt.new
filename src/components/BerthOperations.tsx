            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="bg-white rounded-lg p-4 border border-gray-200">
                <div className="flex items-center justify-between mb-3">
                  <p className="text-sm font-medium text-gray-600">Vessel Identification</p>
                  <span className="px-2 py-1 bg-green-100 text-green-800 text-xs font-medium rounded">
                    OCR Verified
                  </span>
                </div>
                <img 
                  src="https://images.pexels.com/photos/163236/luxury-yacht-boat-speed-water-163236.jpeg?auto=compress&cs=tinysrgb&w=600&h=300&fit=crop"
                  alt="Vessel with identification number"
                  className="w-full h-48 object-cover rounded-lg mb-3"
                />
                <div className="bg-blue-50 rounded-lg p-3 border border-blue-200">
                  <p className="text-xs font-medium text-blue-700 mb-1">Detected Vessel Name</p>
                  <p className="text-lg font-bold text-blue-900">{selectedVessel.vesselName}</p>
                  <p className="text-xs text-blue-600 mt-1">Confidence: 99.2% | Location: Port Approach</p>
                </div>
              </div>
              
              <div className="bg-white rounded-lg p-4 border border-gray-200">
                <div className="flex items-center justify-between mb-3">
                  <p className="text-sm font-medium text-gray-600">IMO Number Detection</p>
                ...
                <img 
                  ...
                  alt="Vessel IMO number identification"
                  className="w-full h-48 object-cover rounded-lg mb-3"
                />
                <div className="bg-purple-50 rounded-lg p-3 border border-purple-200">
                  <p className="text-xs font-medium text-purple-700 mb-1">IMO Registration</p>
                  <p className="text-sm font-semibold text-purple-900">{selectedVessel.imoNumber}</p>
                  <p className="text-xs text-purple-600 mt-1">Flag: {selectedVessel.flag} | Length: {selectedVessel.length}m</p>
                </div>
              </div>
            </div>
          </div>
